 ...
 *       Wait time in sample number before triggering the tilt event when the tilt threshold is reached or over pass
 *       Unit: in sample number - ODR dependent
 *       Default value: 200 (corresponding to 4s at 50Hz)
 *       Recommended range value: [25 - 1000]
 *       Format: int16_t
 *     
 */
 ...
 *       warning acceptable value: 0 to 4 => 0 bike and transport detected some false SMD detection in rejection use case
 *       4=> missing bike and almost no transport detected, minimal SMD detection in rejection use case
 *       Unit: integer, from 0 to 4
 *       Default value 0
 *       Format: int8_t
 *     
 */
 ...
 *       Set the motion detection resolution, the bigger angle (smaller value of cosine) needs bigger amplitude motion to trigger a R2W,
 *       Unit: cosine value of angle in q30
 *       Default: 1046221864 corresponding to 13 degree
 *       Recommended value: [130856211 - 1069655912], corresponding to angle between 5 and 85 degrees
 *       Format: int32_t
 *     
 */
 ...
 *       Unit: Time in ms (not ODR dependent)
 *       Default value: 240
 *       Recommended range value: [100- 500]
 *       Format: int32_t
 *     
 */
 ...
 *       Unit: Time in ms (not ODR dependent)
 *       Default value: 2600
 *       Recommended range value: [1000- 10000]
 *       Format: int32_t
 *     
 */
 ...
 *       Unit: Time in ms (not ODR dependent)
 *       Default value: 240
 *       Recommended range value: [100- 2000]
 *       Format: int32_t
 *     
 */
 ...
 *       Any of the absolute accelerometer axis surpasses high_peak_thres will potentially trigger the start of HighG state
 *       Unit: in LSB, with 1 LBS = 1g / 2^12
 *       Default value: 29696 (corresponding to 7.25g)
 *       Recommended range value: [1024-32768]
 *     
 */
 ...
 *       A hysteresis high_peak_thres_hyst is substracted from the threshold (high_peak_thres) after the initial threshold is met
 *       Unit: in LSB, with 1 LBS = 1g / 2^12
 ...
 *       Use value in range [1 - 63] 
 *       Default value: 32, algorithm will detect only -Z tap (also called backtap) - Note use value 63 to detect tap in all axis, direction
 *       Format: uint8_t
 *     
 */
 ...
 *       Threshold on maximal energy on primary axis to check validity of tap - Note: only for tap directionnal rejection
 *       Unit: No unit
 *       Use value in range [1000 - 10000] 
 *       Default value: 3000, use 0 to disable this checking 
 *       Format: uint8_t
 *     
 */
 ...
 *       Threshold on maximal energy on secondary axis to check validity of tap detection - Note: only for tap directionnal rejection
 *       Unit: No unit
 *       Use value in range [200 - 1000] 
 *       Default value: 500, use 0 to disable this checking 
 *       Format: uint8_t
 *     
 */
 ...
 *       Indicate in case of triple tap, the sample count of the triple pulse detected in the detection window
 *       Unit: time in sample number
 *       Format: uint8_t
 *     
 */
 ...
 *       RevB2S threshold, condition satisfied when moving away from bring2see orientation position
 *       by more than threshold angle corresponding to the cosinus angle
 *       Unit: cosinus value of angle in q30
 ...
 *       Used for shake axis detection. Axis detection threshold added before comparison between two axis to select the majority axis
 *       with this formula majority_axis_nb > minority_axis_nb + shake_axis_majority_th
