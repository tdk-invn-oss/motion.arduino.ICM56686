 ...
 *  @param[in]  s           Pointer to device.
 *  @param[out] Bump_params  Pointer to Bump configuration structure, which will hold current Bump configuration.
 *  @return                 0 on success, negative value on error.
 */
 ...
 *  @param[in]  s           Pointer to device.
 *  @param[in]  Bump_params  Pointer to Bump configuration structure, which contains new Bump configuration.
 *  @return                 0 on success, negative value on error.
 */
